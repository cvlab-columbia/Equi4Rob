...
class DRN_linearAdapt(nn.Module):

    def __init__(self, block, layers, num_classes=1000,
                 channels=(16, 32, 64, 128, 256, 512, 512, 512),
                 out_map=False, out_middle=False, pool_size=28, arch='D'):
        super(DRN_linearAdapt, self).__init__()
...
def drn_d_22_linearada(pretrained=False, **kwargs):
    model = DRN_linearAdapt(BasicBlock, [1, 1, 2, 2, 2, 2, 1, 1], arch='D', **kwargs)
    # if pretrained:
